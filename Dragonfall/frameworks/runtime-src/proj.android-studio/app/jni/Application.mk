...
CC_USE_FACEBOOK := 1
CC_USE_SDK_PAYPAL := 1
CC_USE_GOOGLE_LOGIN := 1
CC_USE_TAKING_DATA := 1
CC_USE_APPSFLYER := 1
CC_USE_PNG_WITH_RGB_A_JPG := 1

ifeq ($(CC_USE_APPSFLYER),1)
APP_CPPFLAGS += -DCC_USE_APPSFLYER=1
else
APP_CPPFLAGS += -DCC_USE_APPSFLYER=0
endif

ifeq ($(CC_USE_TAKING_DATA),1)
APP_CPPFLAGS += -DCC_USE_TAKING_DATA=1
else
APP_CPPFLAGS += -DCC_USE_TAKING_DATA=0
endif

ifeq ($(CC_USE_GOOGLE_LOGIN),1)
APP_CPPFLAGS += -DCC_USE_GOOGLE_LOGIN=1
else
APP_CPPFLAGS += -DCC_USE_GOOGLE_LOGIN=0
endif
...
ifeq ($(CC_USE_PNG_WITH_RGB_A_JPG),1)
APP_CPPFLAGS += -DCC_USE_PNG_WITH_RGB_A_JPG=1
else
APP_CPPFLAGS += -DCC_USE_PNG_WITH_RGB_A_JPG=0
endif
...
APP_CPPFLAGS += -DBUGLY_VERSION=$(BUGLY_VERSION)
