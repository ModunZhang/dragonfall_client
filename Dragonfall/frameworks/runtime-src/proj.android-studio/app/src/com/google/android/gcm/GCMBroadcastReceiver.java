...
/**
 * {@link BroadcastReceiver} that receives GCM messages and delivers them to an application-specific {@link GCMBaseIntentService} subclass.
 * <p>
 * By default, the {@link GCMBaseIntentService} class belongs to the application main package and is named
 * {@link GCMConstants#DEFAULT_INTENT_SERVICE_CLASS_NAME}. To use a new class, the {@link #getGCMIntentServiceClassName(Context)} must be
 * overridden.
 */
public class GCMBroadcastReceiver extends BroadcastReceiver {
	private static final String TAG = "GCMBroadcastReceiver";
	private static final String GCM_INTENT_SERVICE_NAME = "com.batcatstudio.dragonfall.google.gcm.GCMIntentService";
	private static boolean mReceiverSet = false;

	@Override
	public final void onReceive(Context context, Intent intent) {
		DebugUtil.LogVerbose(TAG, "onReceive: " + intent.getAction());
		...
		String className = GCM_INTENT_SERVICE_NAME;
		DebugUtil.LogVerbose(TAG, "GCM IntentService class: " + className);
