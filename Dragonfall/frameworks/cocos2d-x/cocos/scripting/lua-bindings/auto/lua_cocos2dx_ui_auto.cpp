...
int lua_cocos2dx_ui_EditBox_visibleText(lua_State* tolua_S)
{
     int argc = 0;
    cocos2d::ui::EditBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_EditBox_visibleText'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccui.EditBox:visibleText");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_EditBox_visibleText'", nullptr);
            return 0;
        }
        cobj->visibleText(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.EditBox:visibleText",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_EditBox_visibleText'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_EditBox(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EditBox");
        ...
        tolua_function(tolua_S,"visibleText", lua_cocos2dx_ui_EditBox_visibleText);
    tolua_endmodule(tolua_S);
