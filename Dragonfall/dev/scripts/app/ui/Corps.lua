...
local soldier_config = {
    ["swordsman"] = {
        {"bubing_1_90", -90, -150, 0.8},
        {"bubing_2_90", -80, -135, 0.8},
        {"bubing_3_90", -80, -130, 0.8},
    },
    ["ranger"] = {
        {"gongjianshou_1_90", -90, -150, 0.8},
        {"gongjianshou_2_90", -75, -145, 0.8},
        {"gongjianshou_3_90", -75, -145, 0.8},
    },
    ["lancer"] = {
        {"qibing_1_90", -70, -150, 0.8},
        {"qibing_2_90", -70, -150, 0.8},
        {"qibing_3_90", -50, -150, 0.8},
    },
    ["catapult"] = {
        {  "toushiche_90", 30, -80, 1},
        {"toushiche_2_90", 30, -80, 1},
        {"toushiche_3_90", 20, -80, 1},
    },

    -----
    ["sentinel"] = {
        {"shaobing_1_90", -60, -140, 0.8},
        {"shaobing_2_90", -60, -140, 0.8},
        {"shaobing_3_90", -60, -140, 0.8},
    },
    ["crossbowman"] = {
        {"nugongshou_1_90", -90, -160, 0.8},
        {"nugongshou_2_90", -90, -160, 0.8},
        {"nugongshou_3_90", -105, -160, 0.8},
    },
    ["horseArcher"] = {
        {"youqibing_1_90", -70, -140, 0.8},
        {"youqibing_2_90", -60, -140, 0.8},
        {"youqibing_3_90", -60, -140, 0.8},
    },
    ["ballista"] = {
        {"nuche_1_90", 75, -100, 1},
        {"nuche_2_90", 85, -95, 1},
    ...
    ----
    ["skeletonWarrior"] = {
        {"kulouyongshi_90", -80, -160, 0.8},
        {"kulouyongshi_90", -80, -160, 0.8},
        {"kulouyongshi_90", -80, -160, 0.8},
    },
    ["skeletonArcher"] = {
        {"kulousheshou_90", -100, -150, 0.8},
        {"kulousheshou_90", -100, -150, 0.8},
        {"kulousheshou_90", -100, -150, 0.8},
    },
    ["deathKnight"] = {
        {"siwangqishi_90", -70, -145, 0.8},
        {"siwangqishi_90", -70, -145, 0.8},
        {"siwangqishi_90", -70, -145, 0.8},
    },
    ["meatWagon"] = {
        {"jiaorouche_90", 20, -100, 0.8},
        {"jiaorouche_90", 20, -100, 0.8},
        {"jiaorouche_90", 20, -100, 0.8},
    },
}
local pve_soldier_config = {
    ["swordsman"] = {
        {"bubing_1_90", -90, -150, 0.8},
        {"heihua_bubing_2_90", -100, -150, 0.8},
        {"heihua_bubing_3_90", -100, -145, 0.8},
    },
    ["ranger"] = {
        {"gongjianshou_1_90", -90, -150, 0.8},
        {"heihua_gongjianshou_2_90", -125, -150, 0.8},
        {"heihua_gongjianshou_3_90", -70, -145, 0.8},
    },
    ["lancer"] = {
        {"qibing_1_90", -70, -150, 0.8},
        {"heihua_qibing_2_90", -100, -150, 0.8},
        {"heihua_qibing_3_90", -50, -150, 0.8},
    },
    ["catapult"] = {
        {  "toushiche_90", 30, -80, 1},
        {"heihua_toushiche_2_90", 20, -100, 1},
        {"heihua_toushiche_3_90", 20, -100, 1},
    },

    -----
    ["sentinel"] = {
        {"shaobing_1_90", -60, -140, 0.8},
        {"heihua_shaobing_2_90", -110, -130, 0.8},
        {"heihua_shaobing_3_90", -110, -130, 0.8},
    },
    ["crossbowman"] = {
        {"nugongshou_1_90", -90, -160, 0.8},
        {"heihua_nugongshou_2_90", -110, -160, 0.8},
        {"heihua_nugongshou_3_90", -105, -150, 0.8},
    },
    ["horseArcher"] = {
        {"youqibing_1_90", -70, -140, 0.8},
        {"heihua_youqibing_2_90", -70, -140, 0.8},
        {"heihua_youqibing_3_90", -65, -140, 0.8},
    },
    ["ballista"] = {
        {"nuche_1_90", 75, -100, 1},
        {"heihua_nuche_2_90", 0, -130, 1},
        {"heihua_nuche_3_90", 20, -120, 1},
    },
}
