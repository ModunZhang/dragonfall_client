...
function GameUIPveAttack:BuildBossUI()
    ...
    display.newSprite("alliance_shrine_1.png"):addTo(self:GetBody())
        :align(display.CENTER_TOP, 95, h - 110):scale(0.8)
    display.newSprite("alliance_shrine_2.png"):addTo(self:GetBody())
        :align(display.CENTER_TOP, 95, h - 110):scale(0.8)
