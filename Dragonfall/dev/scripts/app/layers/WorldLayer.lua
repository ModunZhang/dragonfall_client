...
function WorldLayer:MoveAllianceFromTo(fromIndex, toIndex)
    ...
    UIKit:CreateMoveSoldiers(degree, {soldiers = {{name = "ranger_3", star = 3}}}, scal)
    ...
    UIKit:CreateMoveSoldiers(degree, {soldiers = {{name = "swordsman_3", star = 3}}}, scal)
        :addTo(self.moveLayer)
    ...
    UIKit:CreateMoveSoldiers(degree, {soldiers = {{name = "lancer_3", star = 3}}}, scal)
        :addTo(self.moveLayer)
