...
local soldier_config = {
    ...
    lancer_1 = {count = 2, scale = 0.6},
    lancer_2 = {count = 2, scale = 0.6},
    lancer_3 = {count = 2, scale = 0.6},
    catapult_1 = {count = 1, scale = 0.5},
    catapult_2 = {count = 1, scale = 0.5},
    catapult_3 = {count = 1, scale = 0.5},
    ...
    horseArcher_1 = {count = 2, scale = 0.6},
    horseArcher_2 = {count = 2, scale = 0.6},
    horseArcher_3 = {count = 2, scale = 0.6},
    ballista_1 = {count = 1, scale = 0.5},
    ballista_2 = {count = 1, scale = 0.5},
    ballista_3 = {count = 1, scale = 0.5},
