...
public:
     ...
     */
    virtual void onPlayerLogin(const char *playerId,const char*playerName,const char*serverName = "");
    /**
     *  虚拟币充值请求
     *
     *  @param orderID               订单号
     ...
     */
    virtual void onPlayerChargeRequst(const char* orderID,const char*productId,double currencyAmount,double virtualCurrencyAmount,const char *currencyType);
    /**
     *  虚拟币充值成功
     *
     *  @param orderID 订单号
     */
    virtual void onPlayerChargeSuccess(const char* orderID);
    /**
     *  虚拟币购买游戏中的道具或者消费宝石
     *
     ...
     */
    virtual void onPlayerBuyGameItems(const char* itemID,int count,double itemPrice);
    /**
     *  消费游戏中的道具
     *
     *  @param itemID 道具的唯一标识
     *  @param count  使用数量
     */
    virtual void onPlayerUseGameItems(const char* itemID,int count = 1);
    /**
     *  玩家获得虚拟币奖励
     *
     *  @param cont 数量
     *  @param reason 奖励原因
     */
    virtual void onPlayerReward(double cont,const char *reason = "奖励");
    /**
     * 初始化函数
     */
