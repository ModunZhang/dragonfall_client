...
def initData():
	if platform == 'Android':initAndroidData()
	if platform == 'WP':pass
	if platform == 'iOS':pass


def getAppVersion():
	if platform == 'Android':return getAndroidAppVersion()
	if platform == 'WP':return getWPAppVersion()
	if platform == 'iOS':pass

def getAppMinVersion():
	if platform == 'Android':return getAndroidAppMinVersion()
	if platform == 'WP':return getWPAppMinVersion()
	if platform == 'iOS':pass
